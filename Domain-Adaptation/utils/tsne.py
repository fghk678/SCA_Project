...
def visualize(source_feature: torch.Tensor, target_feature: torch.Tensor,
              filename: str, labels= None, title = None):
    """
    ...
    if labels is not None:
        ...
        plt.scatter(view1[:, 0], view1[:, 1], c=colors[labels_1], marker='v', s=40)
        plt.scatter(view2[:, 0], view2[:, 1], c=colors[labels_2], marker='o', s=40)
        # plt.xticks([])
        # plt.yticks([])
