...
from utils.tllib.modules.classifier import Classifier as ClassifierBase
from utils.tllib.utils.metric import binary_accuracy, accuracy
...
class ImageClassifier(ClassifierBase):
    def __init__(self, backbone: nn.Module, num_classes: int, bottleneck_dim: Optional[int] = 256, in_features: Optional[int] = None, **kwargs):
