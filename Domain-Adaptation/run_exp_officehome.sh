...
OUTPUT_DIR="output/proposed/resnet50/office_home"
LOGS_DIR="logs/proposed/resnet50/office_home"
...
for i in {1..5}; do
    ...
    python train.py --data_path $DATADIR --data_name OfficeHome --data_folder_name OfficeHome \
    ...
    --temp 0.55 --n_epochs 10 --D 512 --model_type "$MODEL" --n_critic 1 --n_z 1 --class_width 512 \
